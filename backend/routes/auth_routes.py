...
auth_bp.route('/auth/oauth/callback', methods=['POST'])(token_required(AuthController.oauth_callback))
...
auth_bp.route('/auth/logout', methods=['POST'])(token_required(AuthController.logout))
